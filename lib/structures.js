...

    {
        ...
        items: [
            ...
            ...['Light', 'Normal', 'Bold'].map(weight => {
                return {
                    name: `${weight} Weight`,
                    html: `<span class="fw-${weight.toLowerCase()}">${weight} Weight</span>`,
                };
            }),
            ...['Light', 'Normal', 'Bold'].map(weight => {
                return {
                    name: `${weight} Weight Italic`,
                    html: `<span class="fw-${weight.toLowerCase()} fst-italic">${weight} Weight</span>`,
                };
            }),
...

    {
        ...
        items: [
            ...
            },
            {
                ...
                html: `<p class="text-start">Left aligned text on all viewport sizes.</p>`,
            },
            {
            ...
            },
            {
                ...
                html: `<p class="text-end">Right aligned text on all viewport sizes.</p>`,
            },
...

    {
        ...
        items: [
...

            {
                ...
                html: `<div class="d-grid"><button class="btn btn-primary">Block Button</button></div>`,
            },
...

    {
        ...
        items: [
...

            {
                ...
                <form class="was-validated">
                    <div>
                        <input type="file" class="form-control" id="validatedCustomFile${id}" required>
                        <label class="form-label" for="validatedCustomFile${id}">Choose file...</label>
...

    {
        ...
        items: [
            ...
            },
            {
                ...
                html: `<div><img src="https://via.placeholder.com/100x100?text=Thumbnail" class="img-thumbnail float-start" alt="Sample image"/><div class="clearfix"></div></div>`,
            },
            {
                name: 'Right Aligned Image Thumbnail',
                html: `<div><img src="https://via.placeholder.com/100x100?text=Thumbnail" class="img-thumbnail float-end" alt="Sample image"/><div class="clearfix"></div></div>`,
            },
            {
...

    {
        ...
        items: [
            ...
            },
            {
                ...
                html: id => `
                <div class="input-group">
                  <input type="file" class="form-control" id="inputGroupFile${id}" aria-describedby="inputGroupFileAddon${id}" aria-label="Upload">
                  <button class="btn btn-outline-secondary" type="button" id="inputGroupFileAddon${id}">Button</button>
                </div>
                `,
            },
